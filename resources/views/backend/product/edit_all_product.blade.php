...
<div class="container-fluid">
    <div class="card mt-3">
        ...
        <div class="card-body">
            <form action="{{url('Update/All/new/product')}}" method="POST" enctype="multipart/form-data">
             @csrf
                 ...
                 <div class="col-lg-8">
                        <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" value="{{$product->subcategory_id}}" name="subcategory_id" id="subcategory_id">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                            <label>Product Name</label>
                                                <input type="text" class="form-control" name='name' value="{{$product->name}}" class="@error('name') is-invalid @enderror" placeholder="Product Name" require>
                                    </div>
                                            @error('name')
                        ...
                        <div class="row mt-3">
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="description"  class="form-control my-editor" value="" class="@error('description') is-invalid @enderror">{{$product->description}}</textarea>
                                    </textarea>
                                    @error('description')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-3"> 
                                    ...
                                    @if($product->image !=null)
                                        <img src="{{url($product->image)}}" style="height: 120px; width:120px;" alt="">
                                    @endif
                                </div>
                        ...
                        <div class="row mt-3">
                                ...
                                <div class="col-lg-3">
                                        <label>Stock:</label>
                                        <input type="number" value="{{$product->stock}}" class="form-control" name="stock" class="@error('stock') is-invalid @enderror" required>
                                        @error('stock')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                         @enderror
                                    </div>
                                ...
                                <div class="col-lg-3">
                                        ...
                                        <input type="number" value="{{$product->price}}" class="form-control" name="price" class="@error('price') is-invalid @enderror" required>
                                        @error('price')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="trending" id="mon"> <label for="mon">Computer&Laptop</label> &nbsp;&nbsp;
                                                <input type="checkbox" name="new" id="tue"> <label for="tue">New</label> &nbsp;&nbsp;
                                                <input type="checkbox" name="top" id="wed"> <label for="wed">Top Category</label> &nbsp;&nbsp;
                        ...
                        <div class="col-lg-4">
                            ...
                            <h5 class="mt-4">My Current appear in home page :</h5>
                                         @if($product != null)

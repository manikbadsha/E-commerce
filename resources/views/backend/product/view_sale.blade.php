                            ...
                            <tbody>
                                 ...
                                 @foreach($data as $index=>$item)
                                    ...
                                    <td><a href="" class="btn btn-sm btn-danger rounded"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                     ...
                                     <br><br><a href="{{url('approve/product')}}/{{$item->id}}" class="btn btn-sm btn-warning rounded"><i class="fas fa-check-circle"></i></a>
                                     <a href="{{url('decline/order')}}/{{$item->id}}" class="btn btn-sm btn-warning rounded"> <i class="fas fa-times"></i></a>
                                    </td>

                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="{{url('/')}}/frontend_assets/img/product/product4.jpg" alt="Compare Product"></a>
                                            <a href="#" class="category">Furniture</a>
                                            <a href="#" class="title">Rinosin title</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="{{url('/')}}/frontend_assets/img/product/product8.jpg" alt="Compare Product"></a>
                                            <a href="#" class="category">Furniture</a>
                                            <a href="#" class="title">Macro title</a>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="#" class="image"><img src="{{url('/')}}/frontend_assets/img/product/product9.jpg" alt="Compare Product"></a>
                                            <a href="#" class="category">Furniture</a>

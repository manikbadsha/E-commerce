                            ...
                            <figure>
                               <div class="post_header">
                                ...
                                <div class="blog_thumb">
                                   <a href="#"><img src="{{url('/')}}/frontend_assets/img/blog/blog-big1.jpg" alt=""></a>
                               </div>
                            ...
                            <div class="row">
                                    ...
                                    <article class="single_related">
                                        <figure>
                                            <div class="related_thumb">
                                                <img src="{{url('/')}}/frontend_assets/img/blog/blog3.jpg" alt="">
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <article class="single_related">
                                        <figure>
                                            <div class="related_thumb">
                                                <img src="{{url('/')}}/frontend_assets/img/blog/blog4.jpg" alt="">
                                            </div>
                                            <figcaption class="related_content">
                                               <div class="blog_meta">                                        
                                                    <span class="author">By : <a href="#">admin</a> / </span>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <article class="single_related">
                                        <figure>
                                            <div class="related_thumb">
                                                <img src="{{url('/')}}/frontend_assets/img/blog/blog5.jpg" alt="">
                                            </div>
                                            <figcaption class="related_content">
                                               <div class="blog_meta">                                        
                                                    <span class="author">By : <a href="#">admin</a> / </span>
                        ...
                        <div class="comments_box">
                            ...
                            <div class="comment_list">
                                <div class="comment_thumb">
                                    <img src="{{url('/')}}/frontend_assets/img/blog/comment3.png.jpg" alt="">
                                </div>
